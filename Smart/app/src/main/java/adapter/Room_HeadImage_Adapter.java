 ...
 */
public class Room_HeadImage_Adapter extends ArrayAdapter<For_ModelHead> {
    ...
    public Room_HeadImage_Adapter(Context context, int resource, List<For_ModelHead> objects) {
